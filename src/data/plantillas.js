...
export const PLANTILLAS_BASE = [
  {
    ...
    items: [
      ...
      { id: "m05", texto: "Temperatura de rodamientos", tipo: "numero", min: "", max: 70, unidad: "°C" },
      ...
      { id: "m09", texto: "Presión del circuito hidráulico (manómetro)", tipo: "numero", min: 150, max: 210, unidad: "bar" },
